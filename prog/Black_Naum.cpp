...
//                outfile << "Real Option Call Price:         " << data.R << std::endl;
//                outfile << "Call Price:                     " << call << std::endl;
//                outfile << "Call Price with dividents:      " << call_w_div << std::endl;

                outfile << data.R << " "; //Real
                outfile << call << " ";   //Classic
                outfile << call_w_div << " "; //Divid
                outfile << std::endl;
